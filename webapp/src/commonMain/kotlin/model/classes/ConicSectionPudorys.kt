...
data class ConicSectionPudorys(
    val a: Float,
    val b: Float,
    val c: Float,
    val d: Float,
...
data class CircleGeom(val center: Offset, val r: Float)
fun ConicSectionPudorys.tryAsCircleGeom(
    epsRel: Float = 1e-4f,
    epsAbs: Float = 1e-6f
): CircleGeom? {
    val a = this.a
    ...
    return CircleGeom(Offset(x0, y0), sqrt(r2))
}
data class ConicInputHyperbolaPudorys(
    val vertex: Offset,
    val axis: Offset,
    val line1: NamedLinePudorys,
    val line2: NamedLinePudorys,
)
