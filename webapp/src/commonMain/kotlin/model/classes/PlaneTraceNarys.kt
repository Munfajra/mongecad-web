...
import utils.UUID
data class PlaneTraceNarys(
    override val point: Point3DNarys,
    override val direction: Offset,
    @Transient override var parent: Plane3D? = null,   // ⚠️ v equals/hashCode ignorovat
...
) : NamedLineNarys, Trace2DProjection, ClippableInNarys {
    ...
    override fun to2DLine(): Line = Line(Offset(point.x, point.z), direction)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is PlaneTraceNarys) return false
        return id == other.id &&
