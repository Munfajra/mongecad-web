...
@Serializable
data class SerializedConicSectionNarys(
    val a: Float,
    val b: Float,
    val c: Float,
    val d: Float,
    ...
    val hyperbolaInput: SerializableConicInputHyperbolaNarys? = null,
...
fun ConicSectionNarys.toSerializable(
    inputPoints: Triple<Offset, Offset, Offset>? = null,
    hyperbolaInput: ConicInputHyperbolaNarys? = null
): SerializedConicSectionNarys {
    return SerializedConicSectionNarys(
        a, b, c, d, e, f,
        name = name,
...
fun SerializedConicSectionNarys.toRuntime(): ConicSectionNarys {
...
fun SerializedConicSectionNarys.toHyperbolaInput(): ConicInputHyperbolaNarys? {
    return hyperbolaInput?.toHyperbolaInput()
}

@Serializable
data class SerializableConicInputHyperbolaNarys(
    val vertex: SerializableOffset,
    val axis: SerializableOffset,
    val line1: SerializableNamedLineNarys,
    val line2: SerializableNamedLineNarys
)

fun ConicInputHyperbolaNarys.toSerializable(): SerializableConicInputHyperbolaNarys {
    return SerializableConicInputHyperbolaNarys(
...
fun SerializableConicInputHyperbolaNarys.toHyperbolaInput(): ConicInputHyperbolaNarys {
    return ConicInputHyperbolaNarys(
