...
fun handleOrthogonalSegmentPudorys(
    cursor: Offset,
    ...
    when (state.projectionPhase) {
        ...
        "segment_orthogonal_place_line_pudorys" -> {
            ...
            setProjectionPhase("segment_orthogonal_first_point_pudorys", state)
            return
        }
        ...
        "segment_orthogonal_first_point_pudorys" -> {
            ...
            setProjectionPhase("segment_orthogonal_second_point_pudorys", state)
            return
        }
        ...
        "segment_orthogonal_second_point_pudorys" -> {
            ...
            state.deferSelectionUntil = System.currentTimeMillis() + 100
            setProjectionPhase("segment_orthogonal_select_direction_pudorys", state)
...
fun handleOrthogonalAssociatedSegmentFromPudorys(
    cursor: Offset,
    snappedPointLogical: Offset?,
    canvasOffset: Offset,
    scale: Float,
