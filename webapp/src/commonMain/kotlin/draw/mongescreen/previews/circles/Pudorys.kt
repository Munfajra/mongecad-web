...
fun DrawScope.drawCirclePreviewPudorys(state: MongeState, snappedPointLogical: Offset?) {
    if (state.drawobjects == Mongeobjects.CIRCLE &&
        ...
        // Červený křížek (vodorovný a svislý)
        val crossSize = 6f
        drawLine(
            color = Color.Red,
