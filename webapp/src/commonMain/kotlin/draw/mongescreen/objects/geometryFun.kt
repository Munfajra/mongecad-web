...
import draw.mongescreen.objects.conics.ConicDegeneracyState
...
fun toModelPlaneEquation(eq: draw.mongescreen.conicarcs.PlaneEquation): PlaneEquation =
...
fun f0Shifted(coeff: ConicCoeffs): Float {
